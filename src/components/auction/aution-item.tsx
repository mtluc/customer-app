'use client'
import autionsSlice, { selectOneAuction } from "@/store/slices/auction/auctions.Slice";
...
const AutionItem = ({ keyOfList, code }: AutionItemProps) => {
    const { image, name, price, bidNumb } = useSelectSlice(autionsSlice, (s) => s[keyOfList]?.entities?.[code])
    return <div
    ...
    >
        ...
        <div className="m-1">
            ...
            <div className="relative h-6">
                {
                    bidNumb && <div className="flex-1 whitespace-nowrap">
